...
export default function MinimalFooter() {
  return (
    <footer style={{ marginTop: '120px', paddingBottom: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '48px', width: '100%' }}>
      <div className="pageend" style={{ margin: 0 }}>— let's build something —</div>
      
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', fontSize: '17px', fontFamily: 'var(--body-font)', paddingTop: '20px', borderTop: '1px solid var(--rule)' }}>
        ...
        {/* Right group: LinkedIn + Behance icons only */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <a href="https://www.linkedin.com/in/ayush-singh-5065881a1/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ color: 'var(--ink)', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a href="https://www.behance.net/ayushsingh83" target="_blank" rel="noopener noreferrer" aria-label="Behance" style={{ color: 'var(--ink)', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
