...
export const CASE_STUDY_1_LINKS = {
  ...
  case2_2: "https://www.figma.com/proto/1NlEmSIcdvEJYf9HIXu8Th/Portfolio?node-id=844-74282&viewport=5642%2C-56%2C0.28&t=IDVVfz8v1DomLRDY-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=844%3A74282&show-proto-sidebar=0&page-id=73%3A3&embed-host=share&hide-ui=1",
